...
# Default Windows 10+ apps
    ...
    [regex]$WhitelistedApps = '|Microsoft.WindowsCalculator|Microsoft.WindowsStore|Microsoft.Windows.Photos|CanonicalGroupLimited.UbuntuonWindows|Microsoft.XboxGameCallableUI|Microsoft.XboxGamingOverlay|Microsoft.Xbox.TCUI|Microsoft.XboxGamingOverlay|Microsoft.XboxIdentityProvider|Microsoft.MSPaint*'
...
Import-Module -DisableNameChecking $PSScriptRoot\src\utils\"individual-tweaks.psm1"
...
Import-Module -DisableNameChecking $PSScriptRoot\src\lib\"set-service-startup.psm1"
Import-Module -DisableNameChecking $PSScriptRoot\src\lib\"title-templates.psm1"
...
Import-Module -DisableNameChecking $PSScriptRoot\src\lib\"set-scheduled-task-state.psm1"
Import-Module -DisableNameChecking $PSScriptRoot\src\lib\"title-templates.psm1"
