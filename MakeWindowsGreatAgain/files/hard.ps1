# HARD MODE BABY LET'S FUCKUP WINDOWS (ironically)
...
function Optimize-ServicesRunning() {
    ...
    $ServicesToDisabled = @(
        ...
        "tzautoupdate"
        "uhssvc"
        "ETDService"                                # Start of HP Services
        "HpTouchpointAnalyticsService"
        "HPAppHelperCap"
        "HPDiagsCap"
        "HPNetworkCap"
        "HPOmenCap"
        "HPSysInfoCap"                              # End of HP Services
        "IntelAudioService"                         # Start of Intel Services
        "Intel(R) Capability Licensing Service TCP IP Interface"
        "cplspcon"
        "cphs"
        "jhi_service"
        "esifsvc"
        "igccservice"                               # End of HP Services
...
Write-Output "Do you want to remove Microsoft Edge? EXPERT USERS ONLY! (y/n)"
$confirm = Read-Host
if ($confirm -eq "y") {
